document.addEventListener('DOMContentLoaded', function(){
     ...
     function encriptar(){
        ...
        document.querySelector('.texto-encriptado').style.background = "#2ea44f"
        texto.innerHTML = "Texto encriptado"
     }
     ...
     function desencriptar(){
        ...
        .replace(/ufat/gi, "u");
        document.querySelector("#encriptado").value = inputTexto;
        document.querySelector('.texto-encriptado').style.background = "#FF4742"
        texto.innerHTML = "Texto desencriptado"
     }
